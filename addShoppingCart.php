<?php
	...
	//3）、传输数据（过桥）
	$result = mysql_query("select * from shoppingCart where vipName='".$vipName."' and goodsCount='".$goodsCount."' and goodsImg='".$goodsImg."' and goodsName='".$goodsName."' and goodsPrice='".$goodsPrice."'",$conn);
	//3.1)先查找该商品是否在购物车中存在
	if(mysql_num_rows($result)>0){
		...
		//如果不存在，则使用insert语句	
		$sqlstr = "insert into shoppingCart values('".$vipName."','".$goodsCount."','".$goodsImg."','".$goodsName."','".$goodsPrice."')";		
	}
